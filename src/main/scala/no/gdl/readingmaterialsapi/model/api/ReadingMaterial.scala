...
case class ReadingMaterial(@(ApiModelProperty@field)(description = "The id of the reading material") id: Long,
                           ...
                           @(ApiModelProperty@field)(description = "Information about reading level") readingLevel: String,
                           ...
                           @(ApiModelProperty@field)(description = "Information about the authors") authors: Seq[Author])
