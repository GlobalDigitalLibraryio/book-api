...
object TestData {
  ...
  object Domain {
    ...
    val DefaultInTranslationFile = InTranslationFile(Some(1), Some(1), 1, FileType.CONTENT, Some(3), None, "filename", "fileId", TranslationStatus.IN_PROGRESS, Some("asdfa342"))
  }
